...
public class CompanyModel : IBaseModel
{
    ...
    [AllowNull] public string? productionAddress { get; set; }
    [AllowNull] public string? director { get; set; }
    [AllowNull] public string? okved_description { get; set; }
    [AllowNull] public string? additionalSiteAddress { get; set; }
    [AllowNull] public string? industry { get; set; }
    [AllowNull] public string? subIndustry { get; set; }
    [AllowNull] public string? mainOkved { get; set; }
    [AllowNull] public string? mainOkvedActivity { get; set; }
    [AllowNull] public string? productionOkved { get; set; }
    [AllowNull] public string? registrationDate { get; set; }
    [AllowNull] public string? head { get; set; }
    [AllowNull] public string? parentOrgName { get; set; }
    public int? parentOrgInn { get; set; }
    [AllowNull] public string? managementContacts { get; set; }
    [AllowNull] public string? orgContact { get; set; }
    [AllowNull] public string? emergencyContact { get; set; }
    [AllowNull] public string? website { get; set; }
    [AllowNull] public string? email { get; set; }
    [AllowNull] public string? supportMeasures { get; set; }
    [AllowNull] public string? specialStatus { get; set; }
    [AllowNull] public string? smeStatus { get; set; }
    ...
    [AllowNull] public string? landCadastral { get; set; }
    public int? landArea { get; set; }
    [AllowNull] public string? landUse { get; set; }
    [AllowNull] public string? landOwnership { get; set; }
    [AllowNull] public string? landOwner { get; set; }

    [AllowNull] public string? oksCadastral { get; set; }
    public int? oksArea { get; set; }
    [AllowNull] public string? oksUse { get; set; }
    [AllowNull] public string? oksType { get; set; }
    [AllowNull] public string? oksOwnership { get; set; }
    [AllowNull] public string? oksOwner { get; set; }

    public int? productionArea { get; set; }
    [AllowNull] public string? standardizedProduct { get; set; }
    [AllowNull] public string? productNames { get; set; }
    [AllowNull] public string? productOkpd2 { get; set; }
    [AllowNull] public string? productSegments { get; set; }
    [AllowNull] public string? productCatalog { get; set; }
    [AllowNull] public string? hasGovOrder { get; set; }
    [AllowNull] public string? capacityUtilization { get; set; }
    [AllowNull] public string? hasExport { get; set; }
    public int? exportPrevYear { get; set; }
    [AllowNull] public string? exportCountries { get; set; }
    [AllowNull] public string? legalCoords { get; set; }
    [AllowNull] public string? productionCoords { get; set; }
    [AllowNull] public string? additionalCoords { get; set; }
    public int? latitude { get; set; }
    public int? longitude { get; set; }
    [AllowNull] public string? okrug { get; set; }
    [AllowNull] public string? district { get; set; }
